;(function () {
  ...
  var trayOptions = {
    ...
    title: Webogram.PLATFORM_WINDOWS ? 'Webogram' : ''
  };

  // var tray_icon = new Webogram.gui.Tray(trayOptions);

  //Tray Icon Right Click Menu
  var tray_menu = new Webogram.gui.Menu({type:"menubar"});
  tray_menu.createMacBuiltin("Telegram");
  Webogram.Window.menu = tray_menu;
